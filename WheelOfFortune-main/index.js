const sectors = [{ label: 'Hadiah A' }, { label: 'Hadiah B' }, { label: 'Hadiah C' }, { label: 'Hadiah D' }, { label: 'Hadiah E' }, { label: 'Hadiah F' }, { label: 'JACKPOT' }, { label: 'Hadiah G' }, { label: 'Hadiah H' }, { label: 'Hadiah I' }, { label: 'Hadiah J' }, { label: 'ZONK' }];
